  ...
  switch (sectionName) {
      ...
      return (
        <div>
          <Landing
            ...
            landingBanner="https://fontmeme.com/temporary/5fb787fc64b6c889fd5aa6eba8d8f649.png"
          />
      ...
      return (
        <div>
          <Landing
            ...
            landingBanner="https://fontmeme.com/temporary/0b01fe42f79ed6589b5c1fa54753a2f7.png"
          />
          <div className="container-grid">
            {pokemon.map((pokemon) => (
              <PokemonCard
    ...
    case 'Forest':
      return (
        <div>
          <Landing
            backgroundImage="https://www.1999.co.jp/itbig59/10592095.jpg"
            landingBanner="https://fontmeme.com/temporary/9a3e8dfb7ac346cc58b2267c0a26bf44.png"
          />
          <div className="container-grid">
            {pokemon.map((pokemon) => (
              <PokemonCard
      ...
      return (
        <div>
          <Landing
            ...
            landingBanner="https://fontmeme.com/temporary/28d246927f644692fc99308b5f1360f8.png"
          />
          <div className="container-grid">
            {pokemon.map((pokemon) => (
              <PokemonCard
      ...
      return (
        <div>
          <Landing
            ...
            landingBanner="https://fontmeme.com/temporary/7948c1128811bb3aae4251ca3034cfae.png"
          />
          <div className="container-grid">
            {pokemon.map((pokemon) => (
              <PokemonCard
      ...
      return (
        <div>
          <Landing
            ...
            landingBanner="https://fontmeme.com/temporary/6e83f5f56d251744f2ac74584e9b413a.png"
          />
          <div className="container-grid">
            {pokemon.map((pokemon) => (
              <PokemonCard
